...
// Admin
export const getAdminStats = (storeId) => API.get('/admin/stats', { params: { storeId } });
...
export const getStockAdjustments = (params) => API.get('/stock/adjustments', { params });
export const createStockAdjustment = (data) => API.post('/stock/adjustments', data);
...
export const updateStockTransferStatus = (id, data) => API.put(`/stock/transfers/${id}/status`, data);
...
export const deleteCustomerReturn = (id) => API.delete(`/returns/customer/${id}`);
